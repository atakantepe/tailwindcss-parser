...
const cssString = fs.readFileSync("src/assets/tailwind-output.css", "utf8");

const obj = parse(cssString);
const classes = {};
const path = 'C:\\Users\\atakan\\Documents\\GitHub\\tailwindcss-parser\\src\\data\\Other.json';
...
for (const section in sections) {
  fs.writeFileSync(`src/data/${section}.json`, JSON.stringify(sections[section], null, 2));
}